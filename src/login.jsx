...
<div className="main" style={{height:'100vh',width:'100vw',display:'flex',flexDirection:'row',}}>
      ...
      <input type = "text" placeholder="Email" onInput = {(e) => setFormValue({
            ...formvalue, Email: e.target.value })}value = {formvalue.Email}></input><br/><br/>
      <input type = "text" placeholder="Password" onInput = {(e) => setFormValue({
            ...formvalue, Password: e.target.value })}value = {formvalue.Password}></input><br/><br/>
      <button type = "submit" onClick={handlelogin}>Sign In</button><br/>
      <p>Already have an account?<span className="sign in" style={{cursor:'pointer'}} onClick={() => navigate("/register")}>Sign up</span></p>
      </div>
